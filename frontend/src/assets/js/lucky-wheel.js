function initializeLuckyWheel() {
  // Check if jQuery and GSAP are available
  if (typeof $ === 'undefined' || typeof gsap === 'undefined') {
    console.warn('jQuery or GSAP not loaded, lucky wheel functionality disabled')
    return
  }
  ...
  deg = getRandomInt(360, 1080) // 可以多圈
  console.log(deg)
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initializeLuckyWheel)
} else {
  initializeLuckyWheel()
}

export default initializeLuckyWheel
